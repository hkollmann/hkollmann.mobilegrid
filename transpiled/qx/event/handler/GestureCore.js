  ...
  qx.Bootstrap.define("qx.event.handler.GestureCore", {
    ...
    members: {
      ...
      gestureFinish: function gestureFinish(domEvent, target) {
        ...
        var gesture = this.__P_163_2[domEvent.pointerId]; // delete the long tap
      ...
      __P_163_22: function __P_163_22(deltaX, deltaY, domEvent, target, time) {
        ...
        if (Math.abs(deltaY) < 1 && Math.abs(deltaX) < 1 || this.__P_163_4[oldTimeoutId] || !this.getWindow()) {
...
//# sourceMappingURL=GestureCore.js.map?dt=1635064698516