  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
       ...
       */
      __P_12_0: function __P_12_0(object, clazz, iface, wrap, shouldThrow) {
        // Validate members
       ...
       *   system.
       */
      __P_12_1: function __P_12_1(clazz, methodName) {
       ...
       */
      __P_12_3: function __P_12_3(clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __P_12_4: function __P_12_4(clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      assertObject: function assertObject(object, iface) {
        ...
        this.__P_12_4(clazz, iface, true); // Validate extends, recursive
      ...
      */
       ...
       */
      __P_12_2: function __P_12_2(iface, origFunction, functionName, preCondition) {},
       ...
       */
      __P_12_6: function __P_12_6(name, config) {}
    }
  });
  qx.Interface.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Interface.js.map?dt=1591463651779