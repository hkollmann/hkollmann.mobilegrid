  ...
  qx.Class.define("qx.data.SingleValueBinding", {
    statics: {
      ...
      bind: function bind(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        var targetListenerMap = this.__P_147_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options); // get the property names
          ...
          for (var i = 0; i < propertyNames.length; i++) {
            ...
            if (i == propertyNames.length - 1) {
              ...
              if (arrayIndexValues[i] !== "") {
                ...
                initialPromise = this.__P_147_5(currentValue, targetObject, targetPropertyChain, options, sourceObject); // bind the event
              ...
              var listener = qx.lang.Function.bind(this.__P_147_7, this, context); // store the listener for further processing
        ...
        for (var j = context.index + 1; j < context.propertyNames.length; j++) {
          ...
          if (j == context.propertyNames.length - 1) {
            ...
            if (qx.Class.implementsInterface(source, qx.data.IListData) && context.arrayIndexValues[j] !== "") {
              ...
              this.__P_147_5(currentValue, context.targetObject, context.targetPropertyChain, context.options, context.sources[context.index]); // bind the item event to the new target
      ...
      __P_147_4: function __P_147_4(source, propertyName) {
        ...
        var eventName = this.__P_147_14(source, propertyName); // if no event name could be found
      ...
      __P_147_5: function __P_147_5(value, targetObject, targetPropertyChain, options, sourceObject) {
        ...
        value = this.__P_147_11(value, targetObject, targetPropertyChain, options, sourceObject); // check if the converted value is undefined
        ...
        if (value !== undefined) {
          try {
            var result = this.__P_147_9(targetObject, targetPropertyChain, value); // tell the user that the setter was invoked probably
      ...
      __P_147_6: function __P_147_6(sourceObject, sourceEvent, targetObject, targetProperty, options, arrayIndex) {
        ...
        var bindListener = function bindListener(arrayIndex, e) {
          ...
          // convert the data
          data = qx.data.SingleValueBinding.__P_147_11(data, targetObject, targetProperty, options, sourceObject); // debug message
      ...
      __P_147_8: function __P_147_8(id, sourceObject, sourceEvent, targetObject, targetProperty) {
        ...
        this.__P_147_0[hash].push(binding); // add same binding data indexed by target object
      ...
      getAllBindingsForObject: function getAllBindingsForObject(object) {
        ...
        var sourceBindings = this.__P_147_0[hash]; // get all bindings of object as target

        var targetBindings = this.__P_147_1[hash] ? this.__P_147_1[hash] : [];
...
//# sourceMappingURL=SingleValueBinding.js.map?dt=1591463664116