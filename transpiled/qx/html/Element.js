  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct: function construct(tagName, styles, attributes) {
      ...
      this.__P_46_0 = styles || null;
      this.__P_46_1 = attributes || null;
...

        {
          ...
          for (var hc in scroll) {
            ...
            if (elem && elem.offsetWidth) {
              ...
              if (obj.__P_46_10 != null) {
                obj._domNode.scrollLeft = obj.__P_46_10;
                delete obj.__P_46_10;
              } // ScrollToY


              if (obj.__P_46_11 != null) {
                obj._domNode.scrollTop = obj.__P_46_11;
                delete obj.__P_46_11;
              } // ScrollIntoViewX


              var intoViewX = obj.__P_46_12;
      ...
      __P_46_7: function __P_46_7() {
        {
          if (!this.__P_46_3) {
            ...
            this.__P_46_3 = eventManager.getHandler(qx.event.handler.Focus);
          }
      ...
      __P_46_9: function __P_46_9() {
        {
          if (!this.__P_46_4) {
            var eventManager = qx.event.Registration.getManager(window);
            this.__P_46_4 = eventManager.getDispatcher(qx.event.dispatch.MouseCapture);
          }

          return this.__P_46_4.getCaptureElement();
        }
      },
    ...
    members: {
      ...
      */
      ...
      _serializeImpl: function _serializeImpl(writer) {
        ...
        if (!this._children || !this._children.length) {
          if (qx.html.Element.__P_46_5[this._nodeName]) {
            writer(">");
          } else {
      ...
      */
      ...
      setRoot: function setRoot(root) {
        if (root && !this.__P_46_14) {
          qx.html.Element._hasRoots++;
        } else if (!root && this.__P_46_14) {
          qx.html.Element._hasRoots--;
        }
      ...
      */
      ...
      disableScrolling: function disableScrolling() {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__P_46_18, this);
      },
      ...
      enableScrolling: function enableScrolling() {
        this.removeListener("scroll", this.__P_46_18, this);
      },
      __P_46_19: null,
       ...
       */
      __P_46_18: function __P_46_18(e) {
        if (!this.__P_46_19) {
          this.__P_46_19 = true;
          this._domNode.scrollTop = 0;
          this._domNode.scrollLeft = 0;
          delete this.__P_46_19;
        }
      },
      ...
      */
      ...
      setTextSelection: function setTextSelection(start, end) {
        ...
        qx.html.Element.__P_46_2[this.toHashCode()] = {
          element: this,
          start: start,
          end: end
        };
      ...
      clearTextSelection: function clearTextSelection() {
        ...
        delete qx.html.Element.__P_46_2[this.toHashCode()];
      },
      ...
      */
       ...
       */
      __P_46_20: function __P_46_20(action, args) {
        {
      ...
      capture: function capture(containerCapture) {
        {
          this.__P_46_20("capture", [containerCapture !== false]);
        }
      },
      ...
      */
      ...
      setStyle: function setStyle(key, value, direct) {
        ...
        if (this.__P_46_0[key] == value) {
          return this;
        }

        this._applyStyle(key, value, this.__P_46_0[key]);

        if (value == null) {
          delete this.__P_46_0[key];
        } else {
          this.__P_46_0[key] = value;
        ...
        if (this._domNode) {
          ...
          this.__P_46_15[key] = true; // Register modification
      ...
      getStyle: function getStyle(key) {
        return this.__P_46_0 ? this.__P_46_0[key] : null;
      },
      ...
      */
      ...
      __P_46_22: function __P_46_22(map) {
      ...
      addClass: function addClass(name) {
        ...
        this.setAttribute("class", this.__P_46_22(classes));
        return this;
      },
      ...
      */
      ...
      setAttribute: function setAttribute(key, value, direct) {
        ...
        if (this._domNode) {
          ...
          this.__P_46_16[key] = true; // Register modification
    ...
    */
    destruct: function destruct() {
      ...
      this.setRoot(false);
      this.__P_46_1 = this.__P_46_0 = this.__P_46_16 = this.__P_46_15 = this.__P_46_12 = this.__P_46_13 = null;
    }
  });
  qx.html.Element.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Element.js.map?dt=1645800257424