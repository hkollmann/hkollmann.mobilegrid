  ...
  qx.Class.define("qx.ui.menu.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_137_1.addListener("interval", this._onOpenInterval, this); // Create close timer
    ...
    members: {
      ...
      */
      ...
      _onOpenInterval: function _onOpenInterval(e) {
        // Stop timer
        this.__P_137_1.stop(); // Open menu and reset flag
      ...
      _onCloseInterval: function _onCloseInterval(e) {
        ...
        this.__P_137_2.stop(); // Close menu and reset flag
...
//# sourceMappingURL=Manager.js.map?dt=1645800263665