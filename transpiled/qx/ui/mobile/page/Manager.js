    ...
    */
    ...
    construct: function construct(isTablet, root) {
      ...
      if (this.__P_4_0) {
        ...
        this.__P_4_3.addListener("resize", this._onLayoutChange, this); // On Tablet Mode, no Animation should be shown by default.
...
//# sourceMappingURL=Manager.js.map?dt=1645800253866