  ...
  qx.Mixin.define("qx.ui.mobile.container.MIScroll", {
    ...
    members: {
      ...
      _scrollTo: function _scrollTo(x, y, time) {
        if (this._isScrollable()) {
          ...
          if (this.__P_153_2) {
            this.__P_153_2.scrollTo(-x, -y, time);
          } else {
      ...
      __P_153_0: function __P_153_0() {
        if (!window.iScroll) {
          ...
          loader.on("load", this.__P_153_3, this);
          loader.open("GET", path);
          loader.send();
        } else {
          this.addListenerOnce("appear", function () {
            this._setScroll(this.__P_153_4());
          }, this);
        }
      },
       ...
       */
      __P_153_3: function __P_153_3(request) {
    ...
    */
    destruct: function destruct() {
      this.__P_153_5(); // Cleanup iScroll
