  ...
  qx.Mixin.define("qx.ui.core.MExecutable", {
    ...
    */
    members: {
       ...
       */
      __P_192_3: function __P_192_3(e) {
        if (this.isEnabled()) {
          if (this.__P_192_1) {
            this.__P_192_1 = false;
            return;
      ...
      _applyCommand: function _applyCommand(value, old) {
        ...
        if (value != null) {
          this.__P_192_2 = value.addListener("execute", this.__P_192_3, this);
        } // binding stuff


        var ids = this.__P_192_0;
...
//# sourceMappingURL=MExecutable.js.map?dt=1645800266881