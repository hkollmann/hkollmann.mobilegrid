    ...
    members: {
      ...
      */
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (this.getHeight() == null && this._hasHeightForWidth()) {
          ...
          if (flowHeight != null && flowHeight !== this.__P_39_0) {
            ...
            this.__P_39_0 = flowHeight; // Re-add to layout queue
      ...
      getSizeHint: function getSizeHint(compute) {
        ...
        hint = this.__P_39_3 = this._computeSizeHint(); // Respect height for width
...
//# sourceMappingURL=LayoutItem.js.map?dt=1645800257027