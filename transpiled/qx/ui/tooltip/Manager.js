  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      qx.event.Registration.addListener(document.body, "pointerover", this.__P_100_0, this, true); // Instantiate timers
      ...
      this.__P_100_3.addListener("interval", this.__P_100_4, this); // Init pointer position
    ...
    members: {
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (value) {
          this.__P_100_1.startWith(value.getShowTimeout()); // Register hide handler
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__P_100_0, this, true); // Dispose timers
...
//# sourceMappingURL=Manager.js.map?dt=1645800261216